1) find the post you want by colour and make the changes

2) commit the changes

3) manually delete the previous posts in the rules-and-links channel

4) go to the staff-chat channel and type .refreshRules
